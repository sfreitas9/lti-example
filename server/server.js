...
const Database = require('../node_modules/npm-test-package-sdcs/Provider/mongoDB/Database');
const { platformSchema, registerPlatform } = require('../node_modules/npm-test-package-sdcs/Provider/register_platform');
const { create_oidc_response, create_unique_string } = require("../node_modules/npm-test-package-sdcs/Provider/oidc");
const { launchTool } = require("../node_modules/npm-test-package-sdcs/Provider/launch_validation");
const { tokenMaker } = require("../node_modules/npm-test-package-sdcs/Provider/token_generator");
const { prep_send_score, send_score } = require("../node_modules/npm-test-package-sdcs/Provider/student_score");
